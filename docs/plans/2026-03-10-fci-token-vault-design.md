...
Four independent modules, each specified via type-driven development:

| Sub-component | Responsibility | Dependencies |
|---------------|---------------|--------------|
| **HighWaterMarkMod** | Decaying max tracking (sqrtPriceX96) | Solady expWad, SqrtPriceLibrary |
| **PayoffMod** | Quadratic payoff computation (sqrtPriceX96) | SqrtPriceLibrary.divX96 |
| **deltaPlusToSqrtPriceX96** | Single Q128→sqrtPriceX96 boundary | SqrtPriceLibrary.fractionToSqrtPriceX96 |
| **TokenVault** | Paired mint/burn, USDC custody, ERC-20 | HighWaterMarkMod, PayoffMod, IFCIOracle |

HWM, Payoff, and the conversion function are pure libraries. TokenVault composes them.

## Development Chunks

### Chunk 1: Sub-component Libraries
HighWaterMarkMod (sqrtPriceX96-based), PayoffMod (sqrtPriceX96-based), deltaPlusToSqrtPriceX96 wrapper. Pure math, testable in isolation. No game or vault dependency.
...
- Each sub-component (HWM, PayoffMod, deltaPlusToSqrtPriceX96) specified individually before coding
